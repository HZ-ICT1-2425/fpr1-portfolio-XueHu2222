            ...
            <form action="{{ route('faqs.store') }}" method="POST">
                ...
                <div class="field">
                    ...
                    <textarea name="question" placeholder="Enter a question..."
                              class="textarea @error('question') is-danger @enderror" autocomplete="question">{{ old('question') }}</textarea>
                        @error('question')
                ...
                <div class="field">
                    ...
                    <textarea name="answer" placeholder="Enter a answer..."
                              class="textarea @error('answer') is-danger @enderror" autocomplete="answer">{{ old('answer') }}</textarea>
                        @error('answer')
                        <span class="icon has-text-danger is-small is-right">
                        <i class="fas fa-exclamation-triangle"></i>
                    </span>
